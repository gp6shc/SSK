...
function reactor_register_styles() {
	...
	wp_register_style('animations', get_stylesheet_directory_uri() . '/assets/css/animate.min.css', array(), false, 'all');
	wp_register_style('style', get_stylesheet_directory_uri() . '/style.css', array(), false, 'all');
	wp_register_style('sass', get_stylesheet_directory_uri() . '/assets/css/theme.css', array(), false, 'all');
}
