$(function(){
	...
	$('#school_state').attr('readonly','readonly');
	  ...
	  //Load  states
	var urlStates = 'https://safersmarterkids.org/wp-content/themes/ssk/sf-form2/states.json';
    $.getJSON(urlStates,"", function (data) {
	 ...
	 //Load  Countries
	 var url = 'https://safersmarterkids.org/wp-content/themes/ssk/sf-form2/counties.json';
 ...
 //   });
  ...
  //	$('select').select2({
    ...
    $("#selectCountry").change(function() {
        ...
        var id = $ddl.val();
        	//Load schools data
		 var url = 'https://safersmarterkids.org/wp-content/themes/ssk/sf-form2/schools.json';
	    $.getJSON(url,"", function (data) {
	        var items = "";
